...
import { Check, ChevronDown, Search, ChevronUp, X, CheckCircle2 } from "lucide-react";
    ...
    <div className="h-full flex flex-col bg-slate-50">
      ...
      <div className="bg-white border-t border-slate-200 px-6 py-4">
        <div className="flex items-center justify-between">
          <button type="button" className="h-10 px-4 text-sm font-medium text-slate-500 hover:text-slate-700 transition-colors">
            Cancel
          </button>
      ...
      <ConfirmModal isOpen={showModal} onClose={() => setShowModal(false)} onConfirm={() => { setShowModal(false); alert("Data submitted successfully!"); }} company={company} month={month} />
    </div>
  );
}
