...
const usersData: User[] = [
  ...
  { id: "2", name: "Sahan Viranga", email: "sahanviranga18@gmail.com", role: "Company Director", company: "McLarens Maritime Academy", cluster: "Shipping Services", status: "active", lastLogin: "1 day ago" },
  ...
  { id: "5", name: "Orlando Diggs", email: "orlando.diggs@mclarens.lk", role: "Company Director", company: "GAC Shipping Limited", cluster: "GAC Cluster", status: "active", lastLogin: "1 day ago" },
                  ...
                  <tr key={user.id} className="hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4">
                      <span className={`inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium rounded-full ${
                        ...
                        user.role === "Company Director" ? "bg-emerald-100 text-emerald-700" :
