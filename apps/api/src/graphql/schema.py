...
from src.graphql.resolvers.auth import AuthQuery, AuthMutation
from src.graphql.resolvers.admin import AdminQuery, AdminMutation
from src.graphql.resolvers.analytics import AnalyticsQuery, AnalyticsMutation
from src.graphql.resolvers.reports import ReportQuery, ReportMutation
